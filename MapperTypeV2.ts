...
export function applyMappings<A,B>(variable: A, mappings: AB<A,B>, options: {onError: (e: Err) => B}): B; // mappings.length==1
...
export function applyMappings<A,B,C>(variable: A, mappings: ABC<A,B,C>, options: {onError: (e: Err) => C}): C;
...
export function applyMappings<A,B,C,D>(variable: A, mappings: ABCD<A,B,C,D>, options: {onError: (e: Err) => D}): D;
...
export function applyMappings<A,B,C,D,E>(variable: A, mappings: ABCDE<A,B,C,D,E>, options: {onError: (e: Err) => E}): E;
...
export function applyMappings<A,B,C,D,E,F>(variable: A, mappings: ABCDEF<A,B,C,D,E,F>, options: {onError: (e: Err) => F}): F; // mappings.length==5
...
export function applyMappings<A,B,C,D,E,F,G>(variable: A, mappings: ABCDEFG<A,B,C,D,E,F,G>, options: {onError: (e: Err) => G}): G;
...
export function applyMappings(variable: any, mappings: any, options?: Record<any, any>): any {
	if (variable instanceof Err) {
		if (options?.onError !== undefined) {
			return options.onError(variable);
		}
		return variable;
	}
	try {
...
export async function applyMappingsAsync<A>(variable: A, mappings: _A<A>, options: {onError?: (e: Err) => any}): Promise<void>; // mappings is empty
export async function applyMappingsAsync<A,B>(variable: A, mappings: _AB<A,B>, options: {onError: (e: Err) => B}): Promise<B>; // mappings.length==1
...
export async function applyMappingsAsync<A,B,C>(variable: A, mappings: _ABC<A,B,C>, options: {onError: (e: Err) => C}): Promise<C>;
...
export async function applyMappingsAsync<A,B,C,D>(variable: A, mappings: _ABCD<A,B,C,D>, options: {onError: (e: Err) => D}): Promise<D>; // mappings.length==3
...
export async function applyMappingsAsync<A,B,C,D,E>(variable: A, mappings: _ABCDE<A,B,C,D,E>, options: {onError: (e: Err) => E}): Promise<E>;
...
export async function applyMappingsAsync<A,B,C,D,E,F>(variable: A, mappings: _ABCDEF<A,B,C,D,E,F>, options: {onError: (e: Err) => F}): Promise<F>; // mappings.length==5
...
export async function applyMappingsAsync<A,B,C,D,E,F,G>(variable: A, mappings: _ABCDEFG<A,B,C,D,E,F,G>, options: {onError: (e: Err) => G}): Promise<G>;
